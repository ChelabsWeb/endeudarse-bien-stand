...
**[▶ Jugar ahora](https://chelabsweb.github.io/endeudarse-bien-stand/)** — un año en la piel de Joaquín, 10 decisiones, 3 minutos.
...
- **Rejugable**: pool de 8 eventos de decisión (salen 2) + 5 "chequeos rápidos" con datos reales del BCU (sale 1, siempre en el Mes 4) + el shock del Mes 7.
